...
const QUOTE_SELECT = `
  ...
  approved_at, billing_mode, converted_to_order_id,
  customer:customers!quotes_customer_id_fkey(id, full_name, email, phone,
    company_name, customer_type, is_ar_customer, payment_terms),
