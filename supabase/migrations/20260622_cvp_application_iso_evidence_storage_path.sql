-- Add storage_path to screened_items so the recruitment review page can generate
-- signed URLs and let staff open each AI-screened document directly from the panel.
