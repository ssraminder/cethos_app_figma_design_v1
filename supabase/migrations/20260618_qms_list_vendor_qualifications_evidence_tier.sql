-- Add an explicit verification `tier` (verified | screened | unverified) and
-- verified_at to each evidence row so the QMS tab can label honestly without
-- re-deriving the rule client-side. Applied to prod via MCP 2026-06-18.
