      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-3xl font-bold text-red-900">{stats.slaBreached}</p>
          </div>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700">Quote #</th>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700">Customer</th>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700">Status</th>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700">Priority</th>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700">SLA Status</th>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700">Time Remaining</th>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-gray-900">
                        <div className="text-sm">
                          ...
                          <div className="text-gray-500">{review.customer_email || 'N/A'}</div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold ${getPriorityColor(review.priority)}`}>
                          {review.priority}
                        </span>
                      </td>
                      <td className={`px-4 py-3 font-medium ${getSLAColor(review.sla_status)}`}>
        ...
        <div className="mt-4 bg-orange-50 border border-orange-200 rounded-lg p-4">
          <p className="text-sm text-orange-800">
            ...
            Data is fetched from Supabase v_hitl_queue view.
          </p>
        </div>
      </main>
    </div>
