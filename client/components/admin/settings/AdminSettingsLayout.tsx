      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            {/* Logo / Home */}
            <Link to="/admin/hitl" className="flex items-center gap-2 text-gray-900 font-semibold">
            ...
            {session && (
              <div className="flex items-center gap-4">
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-medium text-gray-900">{session.staffName}</p>
                  <p className="text-xs text-gray-500 capitalize">{session.staffRole.replace('_', ' ')}</p>
                </div>
