# Internal email to Bobby Rawat — vendor evidence for COA audit

**To:** Bobby Rawat <bobby.rawat@cethoscorp.com>
**Cc:** Fayza Elbezzari (acting Vendor Management Lead)
**Subject:** ACTION by Fri 20 Jun — 5-yr history + clinical work samples for our COA vendors (IQVIA audit)
...
### 1. Payment / job history — last 5 years
For each vendor (by XTRF #), their **job/PO and payment history since 2021** — a CSV is ideal:
- PO/job ID · date · source>target language · **project/client name** · amount & currency · status (completed/paid)

The single most important point is each vendor's **earliest job date** with us — that's what establishes their years of experience. (If pulling the full export is awkward, even a list of jobs + the first engagement date per vendor works.)

### 2. Sample of clinical work they did
...
|---|---|---|
| Ravindran A | P000029 | Tamil |
| Mugdha Ghate | P000053 | Marathi/Hindi/German |
| Abhinav Dang | P000056 | Hindi |
| Tejinder Soodan | P000058 | Punjabi |
| Abhash Pathak | P000061 | Hindi |
| Raja (R. Rajamanickam) | P000071 | Tamil |
| Jaisy Louis | P000088 | Malayalam |
| Jagjeet | P000224 | Hindi + Punjabi |
| Gurpreet Singh | P000635 | Punjabi |

Send everything to **Fayza** (cc'd) — she's compiling the qualification records. Shout if any vendor's XTRF history looks incomplete and we'll work around it.

Thanks Bobby — appreciate the quick turnaround given the audit date.
